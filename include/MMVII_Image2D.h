...
class cRGBImage
{
     public :
       ...
       */
        ...
        void DrawCross(const cPt2dr& aP1, const cPt2dr& aP2, const cPt3di& aCoul, tREAL8 aWidth);
        void DrawFiducial(const cPt2dr& aP1, const cPt2dr& aP2, tREAL8 aRay, const cPt3di& aCoul, tREAL8 aWidth);
        void DrawPolygon(const std::vector<cPt2dr>& aVPts, const cPt3di& aCoul, tREAL8 aWidth, bool IsClosed=true);
