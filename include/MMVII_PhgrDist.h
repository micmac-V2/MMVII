...
NS_SymbolicDerivative::cCalculator<double> * EqTLS_GCP(bool WithDerive,int aSzBuf,bool ReUse);
NS_SymbolicDerivative::cCalculator<double> * EqTLS_GCPD(bool WithDerive,int aSzBuf,bool ReUse);
