...
class cGeomSimDCT
{
    public :
       ...
       void AddCorrep(const tMap&,const cPt2dr & aPRef);
       std::vector<cPt2dr>   mCoordRef;  ///< coordinates of point in reference image
       std::vector<cPt2dr>   mCoordImSim;   ///< coordinates of points in simul image
