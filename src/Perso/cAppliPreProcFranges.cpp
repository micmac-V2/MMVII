...
{
   public :
    cFitParabol (tREAL8 anYC,tREAL8 anInY,tDIm *,tREAL8 aStep=1.0,tREAL8 aExp=2.0);
...
cFitParabol::cFitParabol (tREAL8 anYC,tREAL8 anIntervY,tDIm * aDIm,tREAL8 aStepY,tREAL8 anExp) :
    mYCenter  (anYC),
    mIntervY  (anIntervY),
...
{
    tREAL8 anX = mX0 + std::pow(std::abs(aDY)/tREAL8(mIntervY),mExp) * mXAtLim;
...
class cAppliFranges : public cMMVII_Appli
{
     ...
     private :
        ...
        tREAL8                  mExpCurve;  /// Exponant for pseudo parabol
        tREAL8                  mFactRed;
        tREAL8                  mLowVal;
        tREAL8                  mVeryLowVal;
        tREAL8                  mHighVal;
...
cCollecSpecArg2007 & cAppliFranges::ArgOpt(cCollecSpecArg2007 & anArgOpt)
{
     ...
     else if (mMode==1)
     {
         anArgOpt
            ...
            << AOpt2007(mExpCurve,"ExpCurve","Exponent for pseudo parabol fit",{eTA2007::HDV})
         ;
     }
...
void   cAppliFranges::ComputeParabol(tREAL8 aX0,tREAL8 aYRel0,tREAL8 aYRel1)
{
    ...
    cFitParabol aFitP(mYCenter,aNbY,mDImBlur,1.0,mExpCurve);
