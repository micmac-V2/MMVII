...
Is a simple Weighter function designed to have standard least-squares weighting for correct measurements and an linear attenuation for suspicious measurements.

Is is aimed at keeping a big number of observations on early stages of adjustment, when parameters are not be well initalized.
