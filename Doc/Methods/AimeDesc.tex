...
\subsection{Localisation du code}

Le calcule de la pyrmide se fait dans l'appelr de {\tt ComputGaussianPyram} de la
classe {\tt cGaussianPyramid}.  Celle ci appelle iterativement le calcul dans
chaque octave, c.a.d la méthode {\tt ComputGaussianFilterOfAllImages} de la classe {\tt cGP\_OneOctave},
qui a sont tour appelle it\'erarivement le calcul  dans chaque image, c.a.d la méthode
{\tt ComputGaussianFilterOfImage} de la classe {\tt cGP\_OneImage}.


C'est donc dans {\tt ComputGaussianFilterOfImage} qu'est impément\'ee l'ensemble des r\`egles 
précédentes.
