...
The command \texttt{OriBundleAdj} can use topo measurements in compensation via the optional parameter \texttt{TopoDirIn}.
It can be used with photogrammetric constraints, or even without images nor ORIs.
